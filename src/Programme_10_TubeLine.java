...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        //List of station in Zone 1 of London
        String [] tubeStationZone1 = new String[]{"Aldgate","Aldgate East", "Angel", "Baker Street", "Bank", "Barbican", "Bayswater", "Blackfriars", "Bond Street", "Borough", "Cannon Street", "Chancery Lane", "Charing Cross", "Covent Garden", "Earl's Court", "Edgeware Road", "Elephant and Castle", "Embankment", "Euston", "Euston Square", "Farringdon", "Glocester Road", "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensignton", "Holborn", "Hyde Park Corner", "King's Cross", "Knightsbridge", "Lambeth North", "Lancaster Gate", "Leicester Square", "Liverpool Street", "London Bridge", "Mansion House", "Marble Arch", "Marylebone", "Monument", "Moorgate", "Notting Hill Gate", "Old Street", "Oxford Circus", "Paddington", "Piccadilly Circus", "Pimlico", "Queensway", "Regent's Park", "Russell Square", "Sloane Square", "South Kensignton", "St Pancras", "St.Paul's", "Temple", "Tottenham Court Road", "Tower Gateway", "Tower Hill", "Vauxhall", "Victoria", "Warren Street", "Waterloo East", "Waterloo", "Westminster"};
        ...
        londonUGLines[2][2] = "Edgeware R9oad";
        ...
        System.out.println("Please enter the tube station's name of Zone 1: ");//input wizard of the user, and store his/her input as a variable
        ...
        //logic to find the lines name from the given input from the user
        if (userTubeStation.equalsIgnoreCase(catchStationName)){
            ...
            for (int x = 0; x < londonUGLines.length; x++){
                for (int y = 0; y < tubeStationZone1.length; y++){
